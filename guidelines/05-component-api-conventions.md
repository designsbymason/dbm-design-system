...
- **Size prop:** always `size`, always the same scale across every component that has one: `xs | sm | md | lg | xl`, mapped to the spacing/icon-size tokens — never invent a component-specific size scale.
