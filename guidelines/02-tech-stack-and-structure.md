...
│   │   └── src/
│   │       ├── hooks/            # useResolvedResponsiveValue, useAnnouncement
...
│   │   │   ├── molecules/        # Built so far (16): Accordion, Card, CheckboxGroup, EmptyState, FormField, Grid, List, NumberInput, Pagination, PasswordInput, Popover, RadioGroup, SearchInput, Select, Slider, Table — Tabs, etc. still open
