...
| `07-storybook-and-documentation-standards.md` | 🔄 In progress (15 of 47 components have a Docs page as of 2026-08-29; 14 of those — Button, Avatar, Badge, Skeleton, Tag, ProgressBar, ProgressCircle, Spinner, Checkbox, IconButton, CloseButton, FieldError, FieldHelperText, FieldLabel — are Finalized. This count will drift again as more land — check that file's own §6 tracking line for the current number rather than trusting this cell to stay current) | Storybook infrastructure (docs/viewport/interaction-test addons), sidebar taxonomy, the per-component Docs-page template, the tracked processing order for the post-Phase-4.75 Storybook refinement pass, version-upgrade fragility (§9), and CI/build reliability (§10) |
