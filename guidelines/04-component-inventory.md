...
**`Radio` (atom, the prerequisite for item 2 below) built and Finalized 2026-09-14** — see [Radio.md](component-reviews/Radio.md); not yet consumed by a real `RadioGroup`, which is next.
